...
namespace culebrita
{
    class Program
    {
        ...
        //metodo dibuja pantalla
        private static void DibujaPantalla(Size size)
        {
            Console.Title = "Culebrita"; //titulo de la ventana
            Console.WindowHeight = size.Height + 2; //altura de la ventana
            Console.WindowWidth = size.Width + 2; //ancho de la ventana
            Console.BufferHeight = Console.WindowHeight; //altura de buffer
            Console.BufferWidth = Console.WindowWidth; //anchura de buffer
            Console.CursorVisible = false; //color visible
            Console.BackgroundColor = ConsoleColor.White; //fondo 
            Console.Clear(); //limpiar la consola

            Console.BackgroundColor = ConsoleColor.Black; //color de fondo negro
        ...
        {
            if (!Console.KeyAvailable) return direccionAcutal; //tecla no esta presionada
        ...
        //obtener la sigueinte direccion
